...
<div class="container theme-showcase" role="main">      
  ...
  <div class="row espaco">
		<div class="pull-right">
			...
			<a href='processa/proc_apagar_cat_doc.php?id=<?php echo $resultado['id']; ?>'><button type='button' class='btn btn-sm btn-danger'>Apagar</button></a>
		</div>
	</div>
  <div class="row">
	<div class="col-md-12">
	  <form class="form-horizontal" method="POST" action="processa/proc_edit_cat_doc.php">
